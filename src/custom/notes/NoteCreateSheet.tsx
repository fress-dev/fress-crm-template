...
import { CreateSheet } from "@/components/atomic-crm/misc/CreateSheet";
import { foreignKeyMapping } from "@/components/atomic-crm/notes/foreignKeyMapping";
import { NoteInputsMobile } from "@/components/atomic-crm/notes/NoteInputsMobile";

import { serializeNoteDate } from "./utils";
...
export const NoteCreateSheet = ({
  ...
  const handleSuccess = async (data: any) => {
    ...
    update("contacts", {
      ...
      data: { last_seen: serializeNoteDate(), status: data.status },
